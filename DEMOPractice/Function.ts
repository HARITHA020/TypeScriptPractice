function Sum(x:number,y:number):number          //named function
{
    return x+y
}
console.log(Sum(2,5));

let add=function Sum(x:number,y:number):number    //anoynmous function
{
    return x+y
}
console.log(add(5,5));
...
//console.log(add2(2,"haritha"))   // type is mismatch with overload
